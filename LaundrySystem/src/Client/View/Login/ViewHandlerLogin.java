...
import Client.View.Login.ChangePassword.ChangePasswordController;
import Client.View.Login.CreateUser.CreateUserController;
import Client.View.Login.Login.LoginController;
...
public class ViewHandlerLogin
{
    private final ViewModelFactory viewModelFactory;
    private Stage mainStage;

    public ViewHandlerLogin(ViewModelFactory lvm) {
